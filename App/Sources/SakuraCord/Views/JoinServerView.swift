...
private struct NativeInvitePreview: NSViewRepresentable {
    let card: NativeTimelineInviteLayout
    ...
    final class Preview: NSView {
        ...
        override func draw(_ dirtyRect: NSRect) {
            ...
            NativeTimelineRowPainter.inviteCard(card, isHovered: false, pressProgress: 0, isModalPreview: true)
        }
        ...
        func loadImages() {
            guard let invite = card?.invite else { return }
